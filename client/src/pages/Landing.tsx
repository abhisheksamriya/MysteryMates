      ...
      <div>
        ...
        <div className="text-center max-w-5xl mx-auto relative z-10">
          ...
          <p className="text-xl md:text-2xl text-zinc-400 mb-8 max-w-3xl mx-auto leading-relaxed font-doto">
            MysteryMates lets you create or join live WebSocket-powered rooms in
            seconds
          </p>

          {/* Feature Indicators */}
          <div className="flex justify-center items-center gap-6 mb-12 text-sm md:text-base">
            <span className="text-zinc-300 font-medium hover:text-green-400 transition-colors font-doto">
              Secure
            </span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              ...
              className="px-8 py-4 bg-green-500 hover:bg-green-600 text-black font-bold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-[0_0_20px_rgba(74,222,128,0.3)] hover:shadow-[0_0_30px_rgba(74,222,128,0.5)] font-doto"
            >
              Get Started
            </button>
            <button className="px-8 py-4 border-2 border-zinc-600 hover:border-green-400 text-zinc-300 hover:text-green-400 font-bold rounded-lg transition-all duration-300 transform hover:scale-105 font-doto">
              Learn More
            </button>
          </div>
